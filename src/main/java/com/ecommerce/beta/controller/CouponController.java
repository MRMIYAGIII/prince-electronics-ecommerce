...
import com.ecommerce.beta.service.impl.CouponServiceImpl;
...
public class CouponController {
    ...
    public String save(@ModelAttribute Coupon coupon) {
        ...
        if (existingCoupon != null) {
            System.out.println("Coupon code already exists " + coupon.getCode());
    ...
    public String deleteById(@PathVariable UUID uuid) {
        ...
        if (userInfo != null) {
            coupon.setDeletedBy(userInfo.getUuid()); // Extract UUID
        }
    ...
    public String deleteByModal(@ModelAttribute Coupon coupon) {
        ...
        UserInfo userInfo = usernameProvider.get();
        if (userInfo != null) {
            existingCoupon.setDeletedBy(userInfo.getUuid()); // Extract UUID
        }
        existingCoupon.setDeletedAt(new Date());
        existingCoupon.setEnabled(false);
